...
<div> Chương 1 khái quát các nội dung giới thiệu về đề tài như lý do hình thành ý tưởng, khảo sát sơ lược các dự án liên quan, đề ra mục tiêu cho đồ án, phát biểu về bài toán, mô tả các quy trình nghiệp vụ, phân tích các yêu cầu chức năng của hệ thống. </div>
