...
--------------------------------------------------------
  ...
  ALTER TABLE "ORGANIZATION" ADD CONSTRAINT "FK_ORG_REGION" FOREIGN KEY ("PROVINCENAME", "DISTRICTNAME", "TOWNNAME") REFERENCES "REGION" ("PROVINCENAME", "DISTRICTNAME", "TOWNNAME") ENABLE
...
--------------------------------------------------------
  ...
  ALTER TABLE "PERSON" ADD CONSTRAINT "FK_PERSON_REGION" FOREIGN KEY ("PROVINCENAME", "DISTRICTNAME", "TOWNNAME") REFERENCES "REGION" ("PROVINCENAME", "DISTRICTNAME", "TOWNNAME") ENABLE
